...
Bias = Q - (jacobian(jacobian(L,dq).',q)*dq - jacobian(L,q).');
...
% Function Generation
% fid=fopen('IRB_1600.m','w');
% fprintf(fid, 'function zdot=IRB_1600(t,z)  \n\n');
% 
% fprintf(fid, 'q1 = z(1);   dq1 = z(7);                          \n');
% fprintf(fid, 'q2 = z(2);   dq2 = z(8);                          \n');
% fprintf(fid, 'q3 = z(3);   dq3 = z(9);                          \n');
% fprintf(fid, 'q4 = z(4);   dq4 = z(10);                         \n');
% fprintf(fid, 'q5 = z(5);   dq5 = z(11);                         \n');
% fprintf(fid, 'q6 = z(6);   dq6 = z(12);                       \n\n');
% 
% fprintf(fid, 'global g t1 t2 t3 t4 t5 t6   \n');
% fprintf(fid, 'global xJ1 yJ1 zJ1   \n');
% fprintf(fid, 'global xG1 yG1 zG1 m1 Ixx1 Iyy1 Izz1 Ixy1 Ixz1 Iyz1   \n');
% fprintf(fid, 'global xJ2 yJ2 zJ2   \n');
% fprintf(fid, 'global xG2 yG2 zG2 m2 Ixx2 Iyy2 Izz2 Ixy2 Ixz2 Iyz2   \n');
% fprintf(fid, 'global xJ3 yJ3 zJ3   \n');
% fprintf(fid, 'global xG3 yG3 zG3 m3 Ixx3 Iyy3 Izz3 Ixy3 Ixz3 Iyz3   \n');
% fprintf(fid, 'global xJ4 yJ4 zJ4   \n');
% fprintf(fid, 'global xG4 yG4 zG4 m4 Ixx4 Iyy4 Izz4 Ixy4 Ixz4 Iyz4   \n');
% fprintf(fid, 'global xJ5 yJ5 zJ5   \n');
% fprintf(fid, 'global xG5 yG5 zG5 m5 Ixx5 Iyy5 Izz5 Ixy5 Ixz5 Iyz5   \n');
% fprintf(fid, 'global xJ6 yJ6 zJ6   \n');
% fprintf(fid, 'global xG6 yG6 zG6 m6 Ixx6 Iyy6 Izz6 Ixy6 Ixz6 Iyz6 \n\n');
% 
% fprintf(fid,'M11 = %s; \n', char((Mass(1,1))) );
% fprintf(fid,'M12 = %s; \n', char((Mass(1,2))) );
% fprintf(fid,'M13 = %s; \n', char((Mass(1,3))) );
...
% fprintf(fid,'\n');
% 
% fprintf(fid,'MM = [M11 M12 M13 M14 M15 M16;                      \n');
...
% 
% fprintf(fid,'BB = [B1;B2;B3;B4;B5;B6];                         \n\n');
% 
% fprintf(fid,'ddq = MM \\ BB;                         \n\n');
% 
% 
% fprintf(fid,'zdot = [dq1;dq2;dq3;dq4;dq5;dq6;ddq];   \n'); 
% fclose(fid);

% Energy Function Generation
fid=fopen('Energy_test.m','w');
fprintf(fid, 'function zdot=Energy_test(z)  \n\n');
...
fprintf(fid, 'global xJ6 yJ6 zJ6        \n');
fprintf(fid, 'global xG6 yG6 zG6 m6 Ixx6 Iyy6 Izz6 Ixy6 Ixz6 Iyz6      \n\n');
fprintf(fid, 'Length = length(z(:,1))        \n');
fprintf(fid, 'dE = zeros (Length , 1);        \n');
fprintf(fid, 'for i = 1:Length        \n');
fprintf(fid, '    E(i) = %s;        \n',   char(E));
fprintf(fid, '    dE(i) = (E(i)- E(1))/E(1);        \n');
fprintf(fid, 'end        \n');
